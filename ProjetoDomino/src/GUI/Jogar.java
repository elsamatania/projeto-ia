...
public class Jogar {
				...
				if(fecha<4){
					if(ordem.get(i) instanceof Humano){
						...
						if(humano.getJogo().tamanho()==0){
							...
							fecha++;
							JOptionPane.showMessageDialog(null,"Voce Passou a vez !!!","Atençao",JOptionPane.WARNING_MESSAGE);
							jogo.getDados().getJogador1().incluir(jogo.getJogo().getLadoA());
							jogo.getDados().getJogador1().incluir(jogo.getJogo().getLadoB());
						}
						...
						if(maq.equals(jogo.getJogo().getJogador2())){
							try {
								...
								JOptionPane.showMessageDialog(null,maq.getNome()+" Passou a vez !!!","Atençao",JOptionPane.WARNING_MESSAGE);
								jogo.getDados().getJogador2().incluir(jogo.getJogo().getLadoA());
								jogo.getDados().getJogador2().incluir(jogo.getJogo().getLadoB());
							}
							...
							try {
								...
								JOptionPane.showMessageDialog(null,maq.getNome()+" Passou a vez !!!","Atençao",JOptionPane.WARNING_MESSAGE);
								jogo.getDados().getJogador3().incluir(jogo.getJogo().getLadoA());
								jogo.getDados().getJogador3().incluir(jogo.getJogo().getLadoB());
							}
							...
							try {
								...
								JOptionPane.showMessageDialog(null,maq.getNome()+" Passou a vez !!!","Atençao",JOptionPane.WARNING_MESSAGE);
								jogo.getDados().getJogador4().incluir(jogo.getJogo().getLadoA());
								jogo.getDados().getJogador4().incluir(jogo.getJogo().getLadoB());
							}
	...
	private void maquinaJogar(Maquina maq) throws PecaInvalidaException, NaoTemPecaException{
	...
	private void maquinaJogarPrimeiraPeca(Maquina maq) throws PecaInvalidaException{
		boolean achou=false;
